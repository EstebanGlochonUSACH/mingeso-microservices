...
public class Orden
{
	...
	private mingeso.proyecto.autofix_reparaciones.entities.Auto auto;

	@OneToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "id_bono", nullable = true)
	private mingeso.proyecto.autofix_reparaciones.entities.Bono bono;
	...
	private List<mingeso.proyecto.autofix_reparaciones.entities.Reparacion> reparaciones = new ArrayList<mingeso.proyecto.autofix_reparaciones.entities.Reparacion>();

	public Orden() {}

	public Orden(mingeso.proyecto.autofix_reparaciones.entities.Auto auto){
		this.auto = auto;
	...
	public mingeso.proyecto.autofix_reparaciones.entities.Auto getAuto() {
		return auto;
	}

	public void setAuto(mingeso.proyecto.autofix_reparaciones.entities.Auto auto) {
		this.auto = auto;
	}

	public mingeso.proyecto.autofix_reparaciones.entities.Bono getBono() {
		return bono;
	}

	public void setBono(mingeso.proyecto.autofix_reparaciones.entities.Bono bono) {
		this.bono = bono;
	}
	...
	public List<mingeso.proyecto.autofix_reparaciones.entities.Reparacion> getReparaciones() {
		return reparaciones;
	}
}
