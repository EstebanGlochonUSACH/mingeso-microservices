	...
	return (
		<Container className="py-2">
			<Nav className="mb-2" variant="pills" activeKey={tab} onSelect={handleSelectTab}>
				...
				<Nav.Item>
					<Nav.Link eventKey="reparaciones-tipo-mes">Reparaciones / Tipo Mes</Nav.Link>
				</Nav.Item>
				<Nav.Item>
					<Nav.Link eventKey="ordenes-analytics">Reparaciones Totales</Nav.Link>
				</Nav.Item>
			</Nav>
			<Routes>
				<Route path="" element={<Navigate to={DEFAULT_ROUTE} />} />
				<Route path="/reparaciones-tipo-auto" element={<ViewReporte1 />} />
				<Route path="/reparaciones-tipo-mes" element={<ViewReporte2 />} />
				<Route path="/ordenes-analytics" element={<ViewReporte3 />} />
			</Routes>
		</Container>
	);
};
