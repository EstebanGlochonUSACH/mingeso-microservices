...
public class Auto
{
	...
	public Auto(String patente, mingeso.proyecto.autofix_reportes.entities.Marca marca, String modelo, Tipo tipo, Integer anio, Motor motor, Integer asientos) {
	...
	public Auto(String patente, mingeso.proyecto.autofix_reportes.entities.Marca marca, String modelo, Tipo tipo, Integer anio, Motor motor, Integer asientos, Integer kilometraje) {
		this.patente = patente;
		this.marca = marca;
		this.modelo = modelo;
		this.tipo = tipo;
