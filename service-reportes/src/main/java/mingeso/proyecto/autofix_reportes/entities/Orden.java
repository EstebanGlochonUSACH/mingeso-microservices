...
public class Orden
{
	...
	private mingeso.proyecto.autofix_reportes.entities.Auto auto;

	@OneToOne(fetch = FetchType.EAGER)
	@JoinColumn(name = "id_bono", nullable = true)
	private mingeso.proyecto.autofix_reportes.entities.Bono bono;
	...
	private List<mingeso.proyecto.autofix_reportes.entities.Reparacion> reparaciones = new ArrayList<mingeso.proyecto.autofix_reportes.entities.Reparacion>();

	public Orden() {}

	public Orden(mingeso.proyecto.autofix_reportes.entities.Auto auto){
		this.auto = auto;
	...
	public mingeso.proyecto.autofix_reportes.entities.Auto getAuto() {
		return auto;
	}

	public void setAuto(mingeso.proyecto.autofix_reportes.entities.Auto auto) {
		this.auto = auto;
	}

	public mingeso.proyecto.autofix_reportes.entities.Bono getBono() {
		return bono;
	}

	public void setBono(mingeso.proyecto.autofix_reportes.entities.Bono bono) {
		this.bono = bono;
	}
	...
	public List<mingeso.proyecto.autofix_reportes.entities.Reparacion> getReparaciones() {
		return reparaciones;
	}
}
