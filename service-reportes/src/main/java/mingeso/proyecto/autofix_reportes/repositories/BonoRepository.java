package mingeso.proyecto.autofix_reportes.repositories;
...
import mingeso.proyecto.autofix_reportes.dtos.BonoGroupedByFechaInicioDTO;

@Repository
public interface BonoRepository extends JpaRepository<Bono, Long>
{
	@Query("SELECT new mingeso.proyecto.autofix_vehicles.dtos.BonoGroupedByFechaInicioDTO(b.marca, b.monto, b.fechaInicio, b.fechaTermino, COUNT(b)) " +
